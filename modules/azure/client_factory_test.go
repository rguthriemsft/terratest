...
func TestAutomationAccountClientBaseURISetCorrectly(t *testing.T) {
	var cases = []struct {
		CaseName        string
		EnvironmentName string
		ExpectedBaseURI string
	...
	for _, tt := range cases {
		...
		t.Run(tt.CaseName, func(t *testing.T) {
			...
			// Get a VM client
			client, err := CreateAutomationAccountClientE("")
			require.NoError(t, err)
...
func TestDSCConfigurationClientBaseURISetCorrectly(t *testing.T) {
	var cases = []struct {
		CaseName        string
		EnvironmentName string
		ExpectedBaseURI string
	...
	for _, tt := range cases {
		...
		t.Run(tt.CaseName, func(t *testing.T) {
			...
			// Get a VM client
			client, err := CreateAutomationAccountDscConfigurationClientE("")
			require.NoError(t, err)
...
func TestAutomationAccountDSCCompilationJobClientBaseURISetCorrectly(t *testing.T) {
	var cases = []struct {
		CaseName        string
		EnvironmentName string
		ExpectedBaseURI string
	...
	for _, tt := range cases {
		...
		t.Run(tt.CaseName, func(t *testing.T) {
			...
			// Get a VM client
			client, err := CreateAutomationAccountDscCompilationJobClientE("")
			require.NoError(t, err)
...
func TestAutomationAccountCertificateClientBaseURISetCorrectly(t *testing.T) {
	var cases = []struct {
		CaseName        string
		EnvironmentName string
		ExpectedBaseURI string
	...
	for _, tt := range cases {
		...
		t.Run(tt.CaseName, func(t *testing.T) {
			...
			// Get a VM client
			client, err := CreateAutomationAccountCertficateClientE("")
			require.NoError(t, err)
...
func TestAutomationAccountDscNodeConfigBaseURISetCorrectly(t *testing.T) {
	var cases = []struct {
		CaseName        string
		EnvironmentName string
		ExpectedBaseURI string
	...
	for _, tt := range cases {
		...
		t.Run(tt.CaseName, func(t *testing.T) {
			...
			// Get a VM client
			client, err := CreateAutomationAccountDscNodeConfigClientE("")
			require.NoError(t, err)
...
func TestAutomationAccountRunAsConnectionBaseURISetCorrectly(t *testing.T) {
	var cases = []struct {
		CaseName        string
		EnvironmentName string
		ExpectedBaseURI string
	...
	for _, tt := range cases {
		...
		t.Run(tt.CaseName, func(t *testing.T) {
			...
			// Get a VM client
			client, err := CreateAutomationAccountRunAsConnectionClientE("")
			require.NoError(t, err)
